        ...
        <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          ...
          <div className="text-center lg:w-2/3 w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href={"#contact"}>
                <button className="inline-flex text-white bg-[#cb6ce6] border-0 py-2 px-6 focus:outline-none hover:bg-purple-900 rounded text-lg transition-all duration-300">
                  Contact
                </button>
              </Link>
              <Link
              ...
              >
                <button className="ml-0 sm:ml-6 inline-flex text-white bg-[#cb6ce6] border-0 py-2 px-6 focus:outline-none hover:bg-purple-900 rounded text-lg transition-all duration-300">
                  View LinkedIn
